...
int main()
{
    // freopen("/home/olee/Documents/code/Leetcode-practice/oct-lunch-2019/in.txt","r",stdin);
    int test;
    int n;
    sf1(test);
    // cout<<test<<endl;
    ...
    while(test--) {
        ...
        for(int i = 0;i<dis;i++){
            if (func(0, dis - 1, dis, dis*2 - 1)== false || func(dis,dis*2-1,dis*2,dis*3-1)==false || func(dis*2,dis*3-1,dis*3,n-1)==false){
                flag = false;
                break;
            }
        }
        if(flag == false) printf("-1\n");
        else printf("%d %d %d\n",vec[dis],vec[dis*2],vec[dis*3]); 
